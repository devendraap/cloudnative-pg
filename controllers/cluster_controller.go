...
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=clusters/finalizers,verbs=update
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=clusters/status,verbs=get;watch;update;patch
