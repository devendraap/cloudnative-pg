...
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=poolers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=poolers/status,verbs=get;update;patch;watch
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=poolers/finalizers,verbs=update
