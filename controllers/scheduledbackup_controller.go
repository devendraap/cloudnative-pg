...
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=scheduledbackups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=scheduledbackups/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=postgresql.acceldata.io,resources=backups,verbs=get;list;create
